...
return r.itemStart.call(t,t,n),A({target:o,obj:t,idex:n,frameOpts:r,startValues:l,endValues:c,onFinished:s})})}function s(i,s){n.itemComplete.call(i,i,s),--a||(n.frameComplete.call(t,t),++l<o?(a=t.length,r(e[l])):n.complete.call(t,t))}t=t.length?t:[t],e=e.length?e:[e],n=i.extend({},it,n);const o=e.length;let a=t.length,l=0;n.start.call(t,t);try{r(e[l])}catch(e){C(e,t,n)}}/**
   ...
   *  @private
   */
function D(t,e){const n={duration:t,complete:e};if(i.isFunction(t))n.duration=st,n.complete=t;else if(i.isString(t))switch(t.toLowerCase()){case"fast":n.duration=100;break;case"normal":n.duration=st;break;case"slow":n.duration=800;break;default:
...
n.duration=parseFloat(t)||1}return n}/**
   ...
   *  @private
   */
function k(t,e,n){const r=D(e,n),s=r.start,o=r.complete,a={// maintain explicit inline styles
...
t.css(a),o&&o.call(t,t,e)},this.animate(l,r)}/**
   ...
   *  @private
   */
function M(t,e,n){const r=D(e,n),s=r.start,o=r.complete,a={// maintain explicit inline styles
...
const st=400;/* jQuery Animations }
   ***************************************************************/
return i.fn.extend({show(t,e){return null==t&&null==e?this.css("display",null):M.call(this,1,t,e)},hide(t,e){return null==t&&null==e?this.css("display","none"):M.call(this,0,t,e)},fadeIn(t,e){return M.call(this,1,t,e)},fadeOut(t,e){return M.call(this,0,t,e)},fadeTo(t,e,n){return M.call(this,e,t,n)},slideUp(t,e){return k.call(this,"Up",t,e)},slideDown(t,e){return k.call(this,"Down",t,e)}}),i});